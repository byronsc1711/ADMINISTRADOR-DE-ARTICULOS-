...
if(isset($_POST['guardar'])){
    ...
    $query = "UPDATE articulos set Articulos = '$nombre', Detalle = '$detalle', publicado = '$radiop', archivos = '$radios', media ='$url'  WHERE id= '$id' ";
...
<fieldset class="my-3 bg-indigo-200 text-teal-900 h-full w-full px-6">
        ...
        <table>
            <thead> 
                ...
                <tr>
                    <td width="400">
                    &nbsp &nbsp NOMBRE *<input type="text" name="Nombre" id="Nombre" class="border-2 rounded-sm" placeholder="Ingrese un nombre" maxlength="75" required value="<?php echo $nombre;?>">  
                    </td>

                    <td>
                    <input type="radio" name="publicado" value="1" required id="p"> Publicado
                    <br> 
                    <input type="radio" name="publicado" value="0" required id="no" checked disabled="true"> No Publicado
                    </td>
                </tr>
                </thead>
                </table>
        ...
        <table>
            <thead>
                <tr >
                    ...
                    <td>
                        URL Video: <input class="border-2 rounded-sm" name="VID" type="text" required disabled id="MediaVideo">
                        <br>
                        <br>
                        URL Audio <input class="border-2 rounded-sm" name="AUD" type="file" required disabled id="MediaAudio">
                        <br>
                        <br>
                        URL Imagen <input class="border-2 rounded-sm" name="IMG" type="text" required disabled id="MediaImagen">
                    </td>
                </tr>
